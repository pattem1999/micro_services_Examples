...
public class EmployeeServiceImp implements EmployeeService {
	...
	public EmployeeResponse getEmployeeById(Integer id) {
		...
		// ========================>>>>> REST TEMPLATE <<<<<==========================
		// addressResponse=restTemplate.getForObject(uri+"/address/{id}",
		// AddressResponse.class,id);
	...
	public EmployeeResponse createEmployee(EmployeeResponse employeeResponse) {
		...
		Employee employee = employeeResponseToEmployee(employeeResponse);
		employeeRepository.save(employee);
		
		AddressResponse addressResponse=addressClient.registerAddress(employeeResponse.getAddressResponse());
		employeeResponse.setAddressResponse(addressResponse);
		return employeeResponse;
	}

	private Employee employeeResponseToEmployee(EmployeeResponse employeeResponse) {
		// TODO Auto-generated method stub
		return Employee.builder().employeeId(employeeResponse.getEmployeeId())
				.employeeName(employeeResponse.getEmployeeName()).employeeEmail(employeeResponse.getEmployeeEmail())
				.employeeBloodGroup(employeeResponse.getEmployeeBloodGroup()).build();
	}
